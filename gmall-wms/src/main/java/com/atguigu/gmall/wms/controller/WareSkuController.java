...
public class WareSkuController {
    ...
    @ApiOperation("库存维护-库存维护")
    @GetMapping("sku/{skuId}")
    public ResponseVo<List<WareSkuEntity>> queryWareSkuBuSkuId(@PathVariable("skuId") long skuId){

        List<WareSkuEntity> wareSkuEntityList = this.wareSkuService.list(new QueryWrapper<WareSkuEntity>()
                .eq("sku_id",skuId));
